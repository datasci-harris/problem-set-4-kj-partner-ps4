...
texas_zip_shapefile = zip_shapefile[zip_shapefile['ZCTA5'].str.startswith(('75', '76', '77', '78', '79'))].copy()  # Use .copy() to avoid SettingWithCopyWarning

# Filter the POS data for 2016 and active hospitals
pos_2016 = df_pos_all_years[(df_pos_all_years['Year'] == 2016) & (df_pos_all_years['PGM_TRMNTN_CD'] == 0)]
...
# Convert ZIP codes to integers and merge with hospital counts
texas_zip_shapefile['ZIP_CD'] = texas_zip_shapefile['ZCTA5'].astype(int)  # This line should be fine now
texas_map_data = texas_zip_shapefile.merge(hospital_counts, how='left', left_on='ZIP_CD', right_on='ZIP_CD')

# Use assignment without 'inplace=True' to avoid FutureWarning
texas_map_data['Hospital_Count'] = texas_map_data['Hospital_Count'].fillna(0)

# Convert to GeoJSON for Altair visualization
...
texas_zip_shapefile = zip_shapefile[zip_shapefile['ZCTA5'].str.startswith(('75', '76', '77', '78', '79'))]
