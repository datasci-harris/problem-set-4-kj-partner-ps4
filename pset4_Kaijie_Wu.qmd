...
choropleth = alt.Chart(alt.Data(values=zips_texas_geojson['features'])).mark_geoshape().encode(
    color=alt.Color(
...
```{python}
# Make a copy of zips_texas_centroids and convert 'ZCTA5' to integers
zips_texas_centroids_int = zips_texas_centroids.copy()
zips_texas_centroids_int['ZIP_CD'] = zips_texas_centroids_int['ZCTA5'].astype(int)

# Merge the GeoDataFrame with the closures table
texas_closures_choropleth_data = zips_texas_centroids_int.merge(
